...
typedef enum SBSDKImageFilterType {
    ...
    SBSDKImageFilterTypeLightMapNormalization = 12,
    SBSDKImageFilterTypeBackgroundCorrection = 13,
    SBSDKImageFilterTypeLightmapBinarized = 14,
    SBSDKImageFilterTypeIlluminationNormalizationFilter = 15
