...
/**
 * Returns the transformed corners of the code in the video frame.
 * CGPoint is encoded in NSDictionary.
 * Unified coordinates (0.0f, 0.0f) - (1.0f, 1.0f).
 */
@property(nonatomic, copy, readonly) NSArray<NSDictionary *> *corners;
