 ...
 */
@property(nonatomic, readonly) BOOL canOpenExternally NS_EXTENSION_UNAVAILABLE_IOS("Not available in app extensions");
 ...
 */
- (void)openExternally NS_EXTENSION_UNAVAILABLE_IOS("Not available in app extensions");
